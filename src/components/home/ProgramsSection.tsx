...
import { FaWheatAwn, FaHouseChimney, FaBook, FaHeartPulse, FaDroplet, FaShieldHalved, FaBriefcase, FaArrowLeft } from 'react-icons/fa6';
import { siteData } from '@/lib/data/siteData';

const iconMap: Record<string, any> = { FaWheatAwn, FaHouseChimney, FaBook, FaHeartPulse, FaDroplet, FaShieldHalved, FaBriefcase };
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {siteData.programs.map((program, i) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: `linear-gradient(135deg, ${program.color}15, ${program.color}05)` }} />
                ...
                <div className="relative z-10">
                  ...
                  {program.projects > 0 && (
                    <div className="absolute top-6 right-6 px-3 py-1.5 rounded-full text-xs font-bold text-white shadow-lg" style={{ background: program.color }}>
