...
import { FaArrowLeft, FaUsers, FaMapPin, FaFolder, FaCalendar } from 'react-icons/fa6';
...
export default function ProjectDetailPage() {
  ...
  if (!project) return <div className="pt-navbar container-page section-py text-center">المشروع غير موجود</div>;
    ...
    <div className="pt-navbar">
      <section className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white section-py">
        <div className="container-page">
          ...
          <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-3xl md:text-4xl font-bold mb-4">
            {project.title_ar}
          </motion.h1>
          <div className="flex flex-wrap gap-4 text-white/80 text-sm">
            ...
            <span className={`px-3 py-1 rounded-full text-xs ${project.status === 'active' ? 'bg-green-500' : 'bg-blue-500'}`}>
        ...
        <div className="container-page max-w-4xl">
          {project.image && (
            <div className="mb-8 rounded-2xl overflow-hidden">
              <img src={project.image} alt={project.title_ar} className="w-full h-auto" />
            </div>
          )}
