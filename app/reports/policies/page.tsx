  ...
  useEffect(() => {
    async function fetchReports() {
      try {
        ...
        const policies = data.filter((r) => r.category === 'policy');
      ...
      <section className="section-py bg-gray-50 dark:bg-gray-900">
        <div className="container-page">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {reports.length > 0 ? (
              reports.map((policy, i) => {
                const Icon = policyIcons[policy.category || 'default'] || FaBook;
              ...
              <div className="col-span-2 text-center py-10">
                ...
                <p className="text-gray-500">
                  سيتم إضافة الأدلة والسياسات قريباً
                </p>
              </div>
            )}
          </div>
