                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-1 text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span>{report.downloads || 0} تحميل</span>
                    </div>
                  </div>
                </div>
                <a href={report.file_url || '#'} target="_blank" className="mt-4 md:mt-0 flex items-center gap-2 px-6 py-2 bg-primary-500 text-white rounded-xl hover:bg-primary-600 transition-colors">
                  <FaDownload /> تحميل
                </a>
              </motion.div>
            )) : (
